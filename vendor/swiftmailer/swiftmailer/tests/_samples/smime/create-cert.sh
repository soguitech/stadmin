...
openssl req -new -key sign.key -subj '/CN=Swiftmailer-Admin/O=Swiftmailer/L=Paris/C=FR' -out sign.csr
...
openssl req -new -key encrypt.key -subj '/CN=Swiftmailer-Admin/O=Swiftmailer/L=Paris/C=FR' -out encrypt.csr
